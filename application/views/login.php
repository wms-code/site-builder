			...
			<div class="row-fluid">
				<div class="well" style="width:40%;margin:auto auto;">
					<div class="navbar navbar-static navbar_as_heading">
						<div class="navbar-inner">
							<div class="container" style="width: auto;">
								<a class="brand">WMS Site Builder</a>
								
								<ul class="nav pull-right">									
										<li><a href="<?php echo base_url('user/register') ?>"><i class="icon-large"></i>Register</a></li>
					...
					<form action="<?php echo base_url(); ?>user/auth" method="post">
						...
						<span class="add-on"><i class="icon-large icon-user-1"></i></span><input class="input-xlarge-fluid" name="username" id="username" size="16" type="text" >
						</div>
						</div>
						</div>
						...
						<div class="controls">
						<div class="input-prepend">
						<span class="add-on"><i class="icon-large icon-lock-1"></i></span><input class="input-xlarge-fluid" name="password" id="password" size="16" type="password" >
						</div>
						</div>
						</div>
